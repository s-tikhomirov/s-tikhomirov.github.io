...
Our efforts have resulted in a [paper](/assets/papers/unjamming-lightning.pdf) where we propose a solution that combines small unconditional fees and local reputation.
