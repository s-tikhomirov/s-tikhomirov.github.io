...
In this post, we summarize [our paper](/assets/papers/lightning-probing-parallel-channels.pdf) on channel balance probing in the Lightning network. It supersedes our [earlier work](/lightning-probing/) on this topic.
...
<img width="600" width="800" src="../images/lightning-probing-2/multi-hop.png" alt="A payment path allowing Alice to send one coin to Charlie via Bob."/>
